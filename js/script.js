	...
	function p(e) {
		...
		if (E.generated || R.generated.initial) {
			...
			var P = i.delay,
				...
				M = i.easing;
			E.generated &&
				A.fragments.push({ delayed: "opacity " + L / 1e3 + "s " + M + " " + P / 1e3 + "s", instant: "opacity " + L / 1e3 + "s " + M + " 0s" }),
				R.generated.initial &&
					A.fragments.push({
			...
			x(function () {
				...
				f(i.store.containers, function (e) {
					...
					var t = function (e) {
						...
						return (
							(n =
								e.node === document.documentElement ? ((t = window.pageYOffset), window.pageXOffset) : ((t = e.node.scrollTop), e.node.scrollLeft)),
							{ top: t, left: n }
						);
					}.call(i, e);
		...
		(modules = [
			...
			function (module, exports, __webpack_require__) {
				...
				function determineNewCaretPosition(selectedCaret, tabbed) {
					...
					if (
						(tabbed && (inputmask.isRTL ? (selectedCaret.end = selectedCaret.begin) : (selectedCaret.begin = selectedCaret.end)),
						...
						switch (opts.positionCaretOnClick) {
							...
							default:
								...
								if (clickPosition <= lastPosition)
									selectedCaret.end = selectedCaret.begin = isMask.call(inputmask, clickPosition, !1, !0)
										? clickPosition
				...
				function getBuffer(noCache) {
					...
					return (
						(void 0 !== maskset.buffer && !0 !== noCache) ||
							((maskset.buffer = _validationTests.getMaskTemplate.call(this, !0, getLastValidPosition.call(this), !0)),
				...
				function seekNext(pos, newBlock, fuzzy) {
					...
					for (
						...
						((!0 === newBlock &&
							(!0 !== _validationTests.getTest.call(this, position).match.newBlockMarker || !isMask.call(this, position, void 0, !0))) ||
				...
				(Inputmask.prototype = {
					...
					option: function option(options, noremask) {
						return "string" == typeof options
							...
							? (_inputmask.default.extend(this.userOptions, options), this.el && !0 !== noremask && this.mask(this.el), this)
							: void 0;
					},
					unmaskedvalue: function unmaskedvalue(value) {
						if (
							((this.maskset = this.maskset || (0, _maskLexer.generateMaskSet)(this.opts, this.noMasksCache)), void 0 === this.el || void 0 !== value)
						) {
							...
							_inputHandling.checkVal.call(this, void 0, !1, !1, valueBuffer),
								"function" == typeof this.opts.onBeforeWrite &&
									this.opts.onBeforeWrite.call(this, void 0, _positioning.getBuffer.call(this), 0, this.opts);
						}
					...
					getmetadata: function getmetadata() {
						if (
							((this.maskset = this.maskset || (0, _maskLexer.generateMaskSet)(this.opts, this.noMasksCache)), Array.isArray(this.maskset.metadata))
						) {
			...
			function (module, exports, __webpack_require__) {
				...
				function getTestTemplate(pos, ndxIntlzr, tstPs) {
					...
					return (
						maskset.validPositions[pos] ||
						determineTestTemplate.call(this, pos, getTests.call(this, pos, ndxIntlzr ? ndxIntlzr.slice() : ndxIntlzr, tstPs))
					);
				}
											...
											for (var ndx1 = 0; ndx1 < maltMatches.length; ndx1++) {
												...
												for (var ndx2 = 0; ndx2 < malternateMatches.length; ndx2++) {
													...
													if (
														...
														(void 0 !== altMatch.alternation && altIndexArr.includes(altMatch.locator[altMatch.alternation].toString()))
													) {
											...
											"" !== tst.def &&
												(0 === locator.length
													...
													: tst.locator[alternation] &&
													  -1 === locator[alternation].toString().indexOf(tst.locator[alternation]) &&
			...
			function (module, exports, __webpack_require__) {
					...
					if (void 0 !== alternation) {
						...
						for (
							...
							for (
								...
								((nextPos = isValidRslt.caret || _positioning.getLastValidPosition.call(this, void 0, !0) + 1),
								(input = validInputs[i]),
				...
				function casing(elem, test, pos) {
					...
					switch (opts.casing || test.casing) {
						...
						case "title":
							...
							elem =
								0 === pos || (posBefore && posBefore.input === String.fromCharCode(_keycode.default.SPACE)) ? elem.toUpperCase() : elem.toLowerCase();
							break;
						default:
				...
				function handleRemove(input, k, pos, strict, fromIsValid) {
					...
					if (
						...
						(k === _keycode.default.BACKSPACE ? (k = _keycode.default.DELETE) : k === _keycode.default.DELETE && (k = _keycode.default.BACKSPACE),
						this.isRTL)
					) {
						var pend = pos.end;
					...
					if (
						...
						k === _keycode.default.BACKSPACE
							...
							: k === _keycode.default.DELETE &&
							  pos.begin === pos.end &&
							  (pos.end = _positioning.isMask.call(this, pos.end, !0, !0) ? pos.end + 1 : _positioning.seekNext.call(this, pos.end) + 1),
						!1 !== (offset = revalidateMask.call(this, pos)))
					) {
						if (
							(!0 !== strict && !1 !== opts.keepStatic) ||
							(null !== opts.regex && -1 !== _validationTests.getTest.call(this, pos.begin).match.def.indexOf("|"))
						) {
							...
							if (result) {
								var newPos =
									void 0 !== result.caret
										? result.caret
										: result.pos
										? _positioning.seekNext.call(this, result.pos.begin ? result.pos.begin : result.pos)
				...
				function isValid(pos, c, strict, fromIsValid, fromAlternate, validateOnly, fromCheckval) {
									...
									(rslt =
										null != test.fn
											...
											: (c === test.def || c === opts.skipOptionalPartCharacter) &&
											  "" !== test.def && { c: _validationTests.getPlaceholder.call(inputmask, position, test, !0) || test.def, pos: position }),
									!1 === rslt)
								)
									return !0;
								...
								return (
									(elem =
										elem === opts.skipOptionalPartCharacter && !0 === test.static
											? _validationTests.getPlaceholder.call(inputmask, position, test, !0) || test.def
											: elem),
									...
									(!0 !== rslt && void 0 === rslt.pos && void 0 === rslt.c) ||
										(!1 ===
											revalidateMask.call(
												inputmask,
												pos,
												$.extend({}, tst, { input: casing.call(inputmask, elem, test, validatedPos) }),
												fromIsValid,
												validatedPos
											) &&
											(rslt = !1)),
									...
									if (opts.insertMode || void 0 === maskset.validPositions[_positioning.seekNext.call(inputmask, maskPos)] || pos.end > maskPos) {
										...
										if (
											(maskset.jitOffset[maskPos] &&
												...
												((result = isValid.call(inputmask, maskPos + maskset.jitOffset[maskPos], c, !0)),
					...
					result && void 0 === result.pos && (result.pos = maskPos),
						!1 === result || !0 === validateOnly
							? (_positioning.resetMaskSet.call(inputmask, !0), (maskset.validPositions = $.extend(!0, {}, positionsClone)))
				...
				function positionCanMatchDefinition(pos, testDefinition, opts) {
					for (
						var inputmask = this, maskset = this.maskset, valid = !1, tests = _validationTests.getTests.call(this, pos), tndx = 0;
						tndx < tests.length;
						tndx++
					) {
						if (
					...
					return (
						!1 === valid &&
							...
							(valid = positionCanMatchDefinition.call(this, pos + maskset.jitOffset[pos], testDefinition, opts)),
						valid
					);
				}
				function refreshFromBuffer(start, end, buffer) {
					...
					if (((opts.skipOptionalPartCharacter = ""), !0 === start))
						_positioning.resetMaskSet.call(this),
							...
							(start = 0),
							(end = buffer.length),
							(p = _positioning.determineNewCaretPosition.call(this, { begin: 0, end: 0 }, !1).begin);
					else {
				...
				function revalidateMask(pos, validTest, fromIsValid, validatedPos) {
					...
					if (
						...
						var valid = !0,
							...
							canMatch;
						for (
							validTest && ((maskset.validPositions[validatedPos] = $.extend(!0, {}, validTest)), posMatch++, j++), i = validTest ? end : end - 1;
							i <= lvp;
							i++
						) {
							if (
			...
			function (module, exports, __webpack_require__) {
				...
				function checkVal(input, writeOut, strict, nptvl, initiatingEvent) {
					...
					(opts.skipOptionalPartCharacter = ""),
						...
						(maskset.tests = {}),
						(initialNdx = opts.radixPoint ? _positioning.determineNewCaretPosition.call(inputmask, { begin: 0, end: 0 }).begin : 0),
						...
						(inputValue.forEach(function (charCode, ndx) {
							if (void 0 !== charCode)
								if (
									...
									!1 === _validation.isValid.call(inputmask, ndx, inputValue[ndx], !0, void 0, void 0, !0)
								)
									maskset.p++;
								else {
									...
									isTemplateMatch(initialNdx, charCodes)
										...
										: ((result = _eventhandlers.EventHandlers.keypressEvent.call(inputmask, keypress, !0, !1, strict, inputmask.caretPos.begin)),
				...
				function unmaskedvalue(input) {
					...
					for (var pndx in vps)
						vps[pndx] &&
							vps[pndx].match &&
							(1 != vps[pndx].match.static || (Array.isArray(maskset.metadata) && !0 !== vps[pndx].generatedInput)) &&
					...
					if (
						...
						void 0 === caretPos ||
							...
							_positioning.caret.call(
								...
								void 0 !== event &&
									"keydown" === event.type &&
									(event.keyCode === _keycode.default.DELETE || event.keyCode === _keycode.default.BACKSPACE)
							),
						!0 === triggerEvents)
					) {
						var $input = $(input),
						...
						(input.inputmask.skipInputEvent = !0),
							...
							setTimeout(function () {
								nptVal === _positioning.getBufferTemplate.call(inputmask).join("")
									...
									: !0 === _validation.isComplete.call(inputmask, buffer) && $input.trigger("complete");
							}, 0);
					}
				}
			},
			function (module, exports, __webpack_require__) {
				...
				var EventHandlers = {
								...
								(!1 !== valResult &&
									...
									(forwardPosition =
										void 0 !== valResult.caret
											? valResult.caret
											: _positioning.seekNext.call(inputmask, valResult.pos.begin ? valResult.pos.begin : valResult.pos)),
									(maskset.p = forwardPosition)),
								(forwardPosition =
									opts.numericInput && void 0 === valResult.caret ? _positioning.seekPrevious.call(inputmask, forwardPosition) : forwardPosition),
								!1 !== writeOut &&
									(setTimeout(function () {
					...
					pasteEvent: function pasteEvent(e) {
						...
						if (
							(valueBeforeCaret ==
								(inputmask.isRTL ? _positioning.getBufferTemplate.call(inputmask).slice().reverse() : _positioning.getBufferTemplate.call(inputmask))
					...
					inputFallBackEvent: function inputFallBackEvent(e) {
						...
						function analyseChanges(inputValue, buffer, caretPos) {
							...
							for (i = 0, bl = newBuffer.length; i < bl; i++)
								switch (
									((placeholder = _validationTests.getPlaceholder.call(inputmask, _positioning.translatePosition.call(inputmask, i))), action)
								) {
									case "insertText":
											...
											((oldBuffer[i] !== placeholder || "~" !== oldBuffer[i + 1]) && "~" !== oldBuffer[i])
												? "~" === oldBuffer[i + 1] && oldBuffer[i] === newBuffer[i + 1]
													...
													? ((action = "deleteContentBackward"),
													  (!_positioning.isMask.call(inputmask, _positioning.translatePosition.call(inputmask, i), !0) &&
					...
					blurEvent: function blurEvent(e) {
						...
						if (this.inputmask) {
							...
							"" !== nptValue &&
								...
								inputmask.undoValue !== _positioning.getBuffer.call(inputmask).join("") &&
									((inputmask.undoValue = _positioning.getBuffer.call(inputmask).join("")), $input.trigger("change"));
						}
					},
			...
			function (module, exports, __webpack_require__) {
				...
				(DependencyLib.prototype = { on: _events.on, off: _events.off, trigger: _events.trigger }),
				...
				function mask() {
					...
					function isElementTypeSupported(input, opts) {
						function patchValueProperty(npt) {
									...
									$.valHooks[type] = {
										get: function get(elem) {
											if (elem.inputmask) {
												...
												return -1 !== _positioning.getLastValidPosition.call(inputmask, void 0, void 0, elem.inputmask.maskset.validPositions) ||
													!0 !== opts.nullable
													? result
													: "";
											}
							...
							function installNativeValueSetFallback(npt) {
								_eventruler.EventRuler.on(npt, "mouseenter", function () {
									...
									value !== (inputmask.isRTL ? _positioning.getBuffer.call(inputmask).reverse() : _positioning.getBuffer.call(inputmask)).join("") &&
										(0, _inputHandling.applyInputValue)(this, value);
								});
							}
						...
						var elementType = input.getAttribute("type"),
							isSupported =
								("input" === input.tagName.toLowerCase() && opts.supportsInputType.includes(elementType)) ||
				...
				var EventRuler = {
					on: function on(input, eventName, eventHandler) {
								...
								if (void 0 === inputmask && "FORM" !== this.nodeName) {
									...
									if (
										...
										!(
											that.disabled ||
											(that.readOnly &&
												!(("keydown" === e.type && e.ctrlKey && 67 === e.keyCode) || (!1 === opts.tabThrough && e.keyCode === _keycode.default.TAB)))
										)
									) {
										switch (e.type) {
											case "input":
						...
						["submit", "reset"].includes(eventName)
							? ((ev = ev.bind(input)), null !== input.form && $(input.form).on(eventName, ev))
				...
				function extend() {
					...
					for (
						"boolean" == typeof target && ((deep = target), (target = arguments[i] || {}), i++),
							"object" !== _typeof(target) && "function" != typeof target && (target = {});
						i < length;
						i++
					)
						if (null != (options = arguments[i]))
							for (name in options)
								(src = target[name]),
									(copy = options[name]),
									target !== copy &&
										(deep && copy && ("[object Object]" === Object.prototype.toString.call(copy) || (copyIsArray = Array.isArray(copy)))
											? ((clone = copyIsArray
													? ((copyIsArray = !1), src && Array.isArray(src) ? src : [])
													: src && "[object Object]" === Object.prototype.toString.call(src)
													? src
													: {}),
				...
				function analyseMask(mask, regexMask, opts) {
					...
					function insertTestDefinition(mtoken, element, position) {
						...
						if (regexMask)
							...
							var maskdef =
								(opts.definitions && opts.definitions[element]) || (opts.usePrototypeDefinitions && Inputmask.prototype.definitions[element]);
							maskdef && !escaped
								? mtoken.matches.splice(position++, 0, {
								...
								if (
									...
									return (
										"yyyy" === tokenMatch.targetMatch[0]
											? ((result.insert = [{ pos: result.pos + 1, c: rawYear, strict: !0 }]),
					...
					if ("string" == typeof mask) {
						for (getTokenizer(opts).lastIndex = 0; (match = getTokenizer(opts).exec(format)); ) {
							...
							Object.prototype.hasOwnProperty.call(formatCode, fcode) &&
								((targetProp = formatCode[fcode][2]), (dateOperation = formatCode[fcode][1]), setValue(dateObj, value, opts)),
						...
						postValidation: function postValidation(buffer, pos, c, currentResult, opts, maskset, strict, fromCheckval) {
							...
							if (!1 === currentResult)
								return (
									...
									((validator = formatCode[tokenMatch.targetMatch[0]][0]), new RegExp(validator).test("0" + c))
										? {
												insert: [
													{ pos: pos, c: "0" },
													{ pos: pos + 1, c: c },
					...
					numeric: {
							...
							return (
								...
								opts.unmaskAsNumber
									? ("" !== opts.radixPoint &&
											...
											(processValue = processValue.replace(_escapeRegex.default.call(this, opts.radixPoint), ".")),
						...
						onBeforeWrite: function onBeforeWrite(e, buffer, caretPos, opts) {
							...
							if (leadingzeroes)
								for (
									var caretNdx =
											buffer.join("").lastIndexOf(leadingzeroes[0].split("").reverse().join("")) - (leadingzeroes[0] == leadingzeroes.input ? 0 : 1),
							...
							if (
								...
								if (!0 === opts._radixDance) {
									...
									if (opts.digitsOptional) {
										...
										-1 !== radixPos &&
										(caretPos.begin < radixPos || caretPos.end < radixPos || (e.keyCode === _keycode.default.DELETE && caretPos.begin === radixPos))
									)
										return (
											caretPos.begin !== caretPos.end ||
												(e.keyCode !== _keycode.default.BACKSPACE && e.keyCode !== _keycode.default.BACKSPACE_SAFARI) ||
												caretPos.begin++,
											(bffr = buffer.slice().reverse()),
...
document.addEventListener("DOMContentLoaded", function () {
	const form = document.getElementById("mainblock__form");
	...
	async function formSend(e) {
		...
		if (error === 0) {
			...
			if (response.ok) {
				document.getElementById("mainblock__form").reset();
...
let menu__links = [];
menu__links = document.getElementsByClassName("menu__link");

closeMenu();

function closeMenu(params) {
	for (let index = 0; index < menu__links.length; index++) {
		let element = menu__links[index];
...
let more__but = document.getElementById("more__but");
let more__text = document.getElementById("more__text");
more__but.addEventListener("click", more);

function more() {
	more__but.classList.toggle("active");
	more__text.classList.toggle("active");
}
let more__but2 = document.getElementById("more__but2");
let more__text2 = document.getElementById("more__text2");

more__but2.addEventListener("click", more2);

function more2() {
	more__but2.classList.toggle("active");
	more__text2.classList.toggle("active");
}
...
if (window.innerWidth > 1024) {
	ScrollReveal().reveal(".mainblock__content", {
		distance: "150%",
		origin: "left",
		opacity: 0,
		duration: 1000,
	...
	ScrollReveal().reveal(".nubmers__achiev", {
		distance: "100%",
		origin: "bottom",
		opacity: 0,
		duration: 1000,
	});
	ScrollReveal().reveal(".item-gall", {
		distance: "150%",
		origin: "left",
		opacity: 0,
		duration: 1000,
	});
	ScrollReveal().reveal(".main__form", {
		distance: "150%",
		origin: "left",
		opacity: 0,
		duration: 1000,
	...
	ScrollReveal().reveal(".mainblock__form", {
		distance: "150%",
		origin: "bottom",
		opacity: 0,
		duration: 1000,
...
// let number = document.getElementsByClassName("amount1");
let number2 = document.getElementById("amount2");
let number3 = document.getElementById("amount3");

printNumbers(1, 521, number2, 521);
printNumbers(1, 12, number3, 12);
